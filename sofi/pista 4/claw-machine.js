...
const dropToy = () => {
  console.log("soltar garra")
  arm.el.classList.add('open')
  if (settings.targetToy) {
    console.log('agarro un juguete')
    console.warn('agarro un juguete', settings.targetToy)
    ...
    if(settings.targetToy.toyType == "penguin"){
      setTimeout(() => {
        Swal.fire({
          title: 'Ganasteeee!!!! ❣️',
          html: `
            quien te dijo que era el pinguino?? Gilberto te dijo? jejeje​ <br><br>
            haz llegado muy lejos, felicitaciones, te dejo la proxima pista, si la quieres fisica me dices y te la escribo<br><br>
            <div class='pista'>
              <i>
                Donde el agua choca tranquilamente contra la ribera,<br>
                donde el viento solo te susurra paz,<br>
                donde las nubes parecen al alcance de tus manos… <br>
                allí te espera tu próxima pista.<br>
              </i>
            </di>
            <br><br>
            Psd. Yo voy contigo a por esa pista :)
            `,
          icon: 'error',
...
const vertBtn = new Button({
  ...
  releaseAction: () => {
    ...
    setTimeout(() => {
      arm.el.classList.add('open')
      console.log("desplegar la garraska")
      arm.move({
        moveKey: 'h',
        target: maxArmLength,
        next: () =>
